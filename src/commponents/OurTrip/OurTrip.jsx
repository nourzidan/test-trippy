...
export default function OurTrip() {
  ...
  <h1 className='ourtriptitle' >Our Trip</h1>
    <div className="ourtrip" id='our-t'>
        <OurTripCard image='/test-trippy/assets/img/indonesia.jpg'
        ...
        <OurTripCard image='/test-trippy/assets/img/malaysia.jpg'
        ...
        <OurTripCard image='/test-trippy/assets/img/france.jpg'
